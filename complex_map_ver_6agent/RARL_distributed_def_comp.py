...
def distributed_RARL(Lambda, episodes=30001, step_size=0.0003, slip_prob = 0.0):
    ...
    agent6 = Agent(kappa=0.5, eta_size=env.eta_space.n, Lambda=Lambda, alpha_risk=0.05, grid_shape=[env.n_rows, env.n_cols], eta_space=env.cost_space, grid=custom_grid)
    ...
    for episode in range(episodes):
        ...
        """agent2の軌跡の生成"""
        a2_t = 1
        a2_state_index, a2_info = env.reset(start_pos=[7, 3])
        #print(f'first state : {state_index}')
        #print(f't : {t}')
        #env.render()
        ...
        """agent3の軌跡の生成"""
        a3_t = 1
        a3_state_index, a3_info = env.reset(start_pos=[3, 0])
        #print(f'first state : {state_index}')
        #print(f't : {t}')
        #env.render()
        ...
        """agent5の軌跡の生成"""
        a5_t = 1
        a5_state_index, a5_info = env.reset(start_pos=[1, 2])
        #print(f'first state : {state_index}')
        #print(f't : {t}')
        #env.render()
        ...
        """agent6の軌跡の生成"""
        a6_t = 1
        a6_state_index, a6_info = env.reset(start_pos=[2, 4])
        #print(f'first state : {state_index}')
        #print(f't : {t}')
        #env.render()
        a6_start_position = a6_state_index
        a6_done = False#a3_done == Trueの時episode終了とする
        a6_total_cost = 0
        while not a6_done:
            if a6_t == 1:
                #print(f'get_action_1前のstate:{state}')#デバッグ用
                a6_action, a6_nexteta_index= agent6.get_action_1(a6_state_index)#a_1,Ieta_2を取得(actionはint, probはvariable(float))
                a6_eta_index = 0
            elif a6_t > 1:
                #print(f'get_action_2前のstate:{state}')#デバッグ用
                a6_action, a6_nexteta_index= agent6.get_action_2(a6_state_index, a6_eta_index)#a_t,Ieta_t+1を取得(actionはint, probはvariable(float))
            a6_next_state, a6_cost, a6_terminated, a6_truncated, a6_info_nan = env.step(action=a6_action, agent_number=6)#s_t+1,c_tを取得(next_stateはnp.int64)
            #print(f't : {t}')
            #print(f'とったaction : {action}')
            #print(f'現在位置state : {next_state}')
            agent6.add(cost=a6_cost, eta_index=a6_eta_index, nexteta_index=a6_nexteta_index, state_index=a6_state_index, action=a6_action, time=a6_t)
            a6_state_index = a6_next_state
            a6_eta_index = a6_nexteta_index
            a6_total_cost += a6_cost
            a6_done = a6_terminated or a6_truncated
        ...
        """各エージェントの推定値の更新"""
        #print('update pi1')
        agent1.update_pi1_SGD_distributed(agent_index=1, P=P, z=z1, other_agent1=(2, agent2), other_agent2=(3, agent3), other_agent3=(4, agent4) , other_agent4=(5, agent5) , other_agent5=(6, agent6) ,learning_rate=step_size, kappa=kappa)
        #print('update pi2')
        agent1.update_pi2_SGD_distributed(agent_index=1, P=P, z=z1, other_agent1=(2, agent2), other_agent2=(3, agent3), other_agent3=(4, agent4) , other_agent4=(5, agent5) , other_agent5=(6, agent6) , learning_rate=step_size, kappa=kappa)

        #print('update pi1')
        agent2.update_pi1_SGD_distributed(agent_index=2, P=P, z=z2, other_agent1=(1, agent1), other_agent2=(3, agent3), other_agent3=(4, agent4) , other_agent4=(5, agent5) , other_agent5=(6, agent6) ,learning_rate=step_size, kappa=kappa)
        #print('update pi2')
        agent2.update_pi2_SGD_distributed(agent_index=2, P=P, z=z2, other_agent1=(1, agent1), other_agent2=(3, agent3), other_agent3=(4, agent4) , other_agent4=(5, agent5) , other_agent5=(6, agent6) , learning_rate=step_size, kappa=kappa)

        #print('update pi1')
        agent3.update_pi1_SGD_distributed(agent_index=3, P=P, z=z3, other_agent1=(1, agent1), other_agent2=(2, agent2), other_agent3=(4, agent4) , other_agent4=(5, agent5) , other_agent5=(6, agent6) ,learning_rate=step_size, kappa=kappa)
        #print('update pi2')
        agent3.update_pi2_SGD_distributed(agent_index=3, P=P, z=z3, other_agent1=(1, agent1), other_agent2=(2, agent2),  other_agent3=(4, agent4) , other_agent4=(5, agent5) , other_agent5=(6, agent6) ,learning_rate=step_size, kappa=kappa)
        #print('update pi1')
        agent4.update_pi1_SGD_distributed(agent_index=4, P=P, z=z4, other_agent1=(1, agent1), other_agent2=(2, agent2), other_agent3=(3, agent3) , other_agent4=(5, agent5) , other_agent5=(6, agent6) ,learning_rate=step_size, kappa=kappa)
        #print('update pi2')
        agent4.update_pi2_SGD_distributed(agent_index=4, P=P, z=z4, other_agent1=(1, agent1), other_agent2=(2, agent2), other_agent3=(3, agent3) , other_agent4=(5, agent5) , other_agent5=(6, agent6) , learning_rate=step_size, kappa=kappa)

        #print('update pi1')
        agent5.update_pi1_SGD_distributed(agent_index=5, P=P, z=z5, other_agent1=(1, agent1), other_agent2=(2, agent2), other_agent3=(3, agent3) , other_agent4=(4, agent4) , other_agent5=(6, agent6) ,learning_rate=step_size, kappa=kappa)
        #print('update pi2')
        agent5.update_pi2_SGD_distributed(agent_index=5, P=P, z=z5, other_agent1=(1, agent1), other_agent2=(2, agent2), other_agent3=(3, agent3) , other_agent4=(4, agent4) , other_agent5=(6, agent6) , learning_rate=step_size, kappa=kappa)

        #print('update pi1')
        agent6.update_pi1_SGD_distributed(agent_index=6, P=P, z=z6, other_agent1=(1, agent1), other_agent2=(2, agent2) , other_agent3=(3, agent3) , other_agent4=(4, agent4) , other_agent5=(5, agent5) ,learning_rate=step_size, kappa=kappa)
        #print('update pi2')
        agent6.update_pi2_SGD_distributed(agent_index=6, P=P, z=z6, other_agent1=(1, agent1), other_agent2=(2, agent2),  other_agent3=(3, agent3) , other_agent4=(4, agent4) , other_agent5=(5, agent5) ,learning_rate=step_size, kappa=kappa)
        ...
        for i in range(6):
            new_z1[i] = P[0][0] * z1[i] + P[0][1] * z2[i] + P[0][2] * z3[i] + P[0][3] * z4[i] + P[0][4] * z5[i] + P[0][5] * z6[i]
            new_z2[i] = P[1][0] * z1[i] + P[1][1] * z2[i] + P[1][2] * z3[i] + P[1][3] * z4[i] + P[1][4] * z5[i] + P[1][5] * z6[i]
            new_z3[i] = P[2][0] * z1[i] + P[2][1] * z2[i] + P[2][2] * z3[i] + P[2][3] * z4[i] + P[2][4] * z5[i] + P[2][5] * z6[i]
            new_z4[i] = P[3][0] * z1[i] + P[3][1] * z2[i] + P[3][2] * z3[i] + P[3][3] * z4[i] + P[3][4] * z5[i] + P[3][5] * z6[i]
            new_z5[i] = P[4][0] * z1[i] + P[4][1] * z2[i] + P[4][2] * z3[i] + P[4][3] * z4[i] + P[4][4] * z5[i] + P[4][5] * z6[i]
            new_z6[i] = P[5][0] * z1[i] + P[5][1] * z2[i] + P[5][2] * z3[i] + P[5][3] * z4[i] + P[5][4] * z5[i] + P[5][5] * z6[i]
        z1 = new_z1
        z2 = new_z2
        z3 = new_z3
        z4 = new_z4
        ...
        a6_cost_history.append(a6_total_cost)
        a6_data['cost'] = a6_total_cost
        a6_data['episode'] = episode
        a6_cost_list.append(a6_data)
        ...
        if episode % 10 == 0:
            ...
            print("agent6 : episode :{}, total cost : {:.1f}, start_position : {}, step_size : {}, kappa : {}, time : {}".format(episode, a6_total_cost, a6_start_position, step_size, kappa, a6_t))
        if episode % 100 == 0:
            print('agent1')
            ...
            print('\nagent6')
            """for s in range(agent6.state_size):
                print(f'state : {s}\npi1 : {agent6.pi1.softmax_probs()[s]}')"""
            for s in range(agent3.state_size):
                print(f'state : {s}\npi2 : {agent6.pi2.softmax_probs()[s]}')
    ...
    # DataFrame を保存するファイルパスを指定
    a6_csv_file_path = os.path.join(output_folder, "a6_cost_history.csv")
    df6.to_csv(a6_csv_file_path, index=False)
    ...
    # プロット
    plt.plot(a6_cost_history)
    plt.xlabel('Episode')
    plt.ylabel('Total Cost')
    plt.title('Cost History')
    # プロット画像をサブフォルダ内に保存
    output_path = os.path.join(output_folder, 'a6_cost_history.png')
    plt.savefig(output_path, dpi=300, bbox_inches='tight')  # 解像度を指定して保存
    #plt.show()
    ...
    # pi1.txt と pi2.txt を cost_history.csv と同じディレクトリに作成
    a6_pi1_file_path = os.path.join(output_folder, "a6_pi1.txt")
    a6_pi2_file_path = os.path.join(output_folder, "a6_pi2.txt")

    # pi1.txt の内容
    with open(a6_pi1_file_path, "w") as file:
        for s in range(agent6.state_size):
                file.write(f'state : {s}\npi1 : {agent6.pi1.softmax_probs()[s]}\n')

    # pi2.txt の内容
    with open(a6_pi2_file_path, "w") as file:
        for s in range(agent6.state_size):
            for eta_index in range(agent6.eta_size):
                file.write(f'state : {s}\neta : {agent6.eta_space[eta_index]}\npi2 : {agent6.pi2.softmax_probs()[s]}\n')